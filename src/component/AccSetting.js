...
import CompAccSetting from "./CompAccSetting"
import CompChangePw from "./CompChangePw"
import CompDelAcc from "./CompDelAcc"
import { Route, Routes, useMatch} from "react-router-dom";
export default function AccSetting() {


  // const { path, url } = matchRoutes();
  const {
    url,
    path,
    params: { eventId },
      ...
      <div className="layout-wrapper layout-content-navbar">
        <div className="layout-container">
          ...
          <div className="layout-page">
            ...
            <Routes>
              <Route path={"./component/CompAccSetting"} element={CompAccSetting} />
              <Route path={"./component/CompChangePw"} element={CompChangePw} />
              <Route path={".component/CompDelAcc"} element={CompDelAcc} />
            </Routes>
          </div>
        </div>
      </div>
